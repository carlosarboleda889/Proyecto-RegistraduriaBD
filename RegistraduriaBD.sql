...
CREATE TABLE Candidato (
    ...
    Edad Int,
    FK_Cod_Partido Int,
    Primary Key (Código_Candidato, Cedula),
...
CREATE TABLE Asociación_Candidato_Padrino (
	...
	FK_Cedula_Cand Int,
	FK_Cod_Padrino Int,
	Foreign Key (FK_Cod_Cand, FK_Cedula_Cand) References Candidato (Código_Candidato, Cedula),
...
INSERT INTO Candidato (Código_Candidato, Cedula, Nombre, Edad, FK_Cod_Partido)
...
INSERT INTO Asociación_Candidato_Padrino (Código_Asociación, FK_Cod_Cand, FK_Cedula_Cand, FK_Cod_Padrino)
...
INSERT INTO HojaDeVida (Código_HojaDeVida, Senador, Año_Inicio_Candidato, Cant_Suspensiones, FK_Cod_Cand, FK_Cedula_Cand)
...
VALUES (501, 'Escuela de Educación Avanzada "Ricardo Palma"'),
       (502, 'Instituto Técnico Industrial "Pedro Domingo Murillo"'),
       (503, 'Colegio de la Comuna 8 "El Salvador"'),
       (504, 'Centro Comunitario "San Javier"'),
       (505, 'Escuela "Manuela Beltrán"'),
       (506, 'Institución Educativa "La Candelaria"'),
       (507, 'Colegio Nacional "Federico García Lorca"'),
...
INSERT INTO Elector (Cédula, Edad, Nombre, FK_Cod_Cand, FK_Cedula_Cand, FK_Cod_Lug_Vot)
VALUES (100001, 30, 'Pedro Navaja', 1001, 50, 501),
       ...
       (100005, 32, 'Luisa Gómez', 1001, 50, 505),
       (100006, 41, 'Sandra López', 1002, 40, 506),
       (100007, 29, 'Diego Sánchez', 1003, 30, 507),
       (100008, 50, 'María Rodríguez', 1004, 20, 508);
